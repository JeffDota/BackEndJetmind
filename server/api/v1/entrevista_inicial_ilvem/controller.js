      ...
      content: [
        ...
        '\n\n',
        {
          ...
          table: {
            body: [
              ['Pregunta', 'Respuesta'],
              ['Apoyo escolar (10mo de básica) Matemáticas, Lenguaje, CCSS, CCNN todo el año, 1 vez a la semana. Horarios establecidos por la institución, separar los 5 primeros días de cada mes ', `${doc.pregunta1}`],
              ['Cambios de Profesores ', `${doc.pregunta2}`],
              ['Cambios de horario siempre que haya disponibilidad ', `${doc.pregunta3}`],
              ['Costos de finalización de la capacitación (certificados)', `${doc.pregunta4}`],
              ['¿Qué lo motivó a tomar la capacitación?', `${doc.pregunta5}`],
